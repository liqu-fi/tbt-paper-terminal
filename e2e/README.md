...
1-click trading has no hermetic tier: since #50 the session key is the SDK-managed
Turnkey session (no pill, no manual grant), and the enclave cannot be mocked.
